...
```
git clone https://github.com/MauricespazzoZeRo/AirBnB_clone.git; cd AirBnB_clone
```
...
Coding and arrangement by: [Umanah Emekobong Maurice](https://github.com/MauricespazzoZeRo)
